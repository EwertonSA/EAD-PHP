                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?=$course['titulo']?>" class="form-control" name="titulo" required>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <label for="descricao">Descrição</label>
                                        <input type="text" class="form-control" value="<?=$course['descricao']?>" name="descricao" required>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <label for="imagem">Imagem</label>
                                        <input type="file" class="form-control" value="<?=$course['imagem']?>" name="imagem" accept="image/*" >
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="preco">Preço</label>
                                        <input type="text" class="form-control" name="preco" required value="<?=$course['preco']?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="conteudo">Conteúdo</label>
                                        <textarea rows="8" class="form-control" name="conteudo" required><?= htmlspecialchars($course['conteudo']) ?></textarea>
